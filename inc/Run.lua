...
if msg.sender_user_id_ == 1030806172 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1

if msg.sender_user_id_ == 1044506670 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/amrkhaled248/kgt/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/amrkhaled248/kgt/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/amrkhaled248/kgt/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/amrkhaled248/kgt/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/amrkhaled248/kgt/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/amrkhaled248/kgt/master/plugins/games.lua','./plugins/games.lua')
